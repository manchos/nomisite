...
$_['entry_email_auth_confirm'] = 'Отправлять на почту e-mail со ссылкой, переход по которой будет подтверждать принадлежность e-mail пользователю, а затем привязывать аккаунт к существующему пользователю';
