    ...
    public function getProductOptionStocks($pId) {
        ...
        foreach ($mix_qry->rows as $row) {
            ...
            foreach ($grp_mix_qry->rows as $row2) {
                $gpArr[$row2['customer_group_id']]['price'] = $row2['price'];
                $gpArr[$row2['customer_group_id']]['date_start'] = $row2['date_start'];
                $gpArr[$row2['customer_group_id']]['date_end'] = $row2['date_end'];
            }
