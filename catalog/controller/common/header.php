<?php
    ...
    class ControllerCommonHeader extends Controller {
       ...
       protected function index() {
          ...
          $this->data['colls'] = array();
          $this->data['colls'] = $this->model_catalog_collection->getCC();
...
//                // Level 2
//                $children_data = array();
////TODO проверить - здесь что столько запросов к БД - охренеть, вроде как точно цикл запросов к БД?
...
//             }
//          }
          $this->registry->set('categories', $this->data['categories'] );
          $this->children = array(
              'module/language',
              'module/currency',
              'module/cart'
