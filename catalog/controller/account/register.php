...
class ControllerAccountRegister extends Controller {
	private $error = array();
  	...
  	public function index() {
            ...
            $this->document->addScript('catalog/view/javascript/jquery/ui/jquery.ui.widget.js');
            $this->document->addStyle('catalog/view/javascript/jquery/colorbox/colorbox.css');
            $this->document->addStyle('catalog/view/javascript/jquery/ui/themes/redmond/jquery.ui.theme.css');
            $this->document->addStyle('catalog/view/javascript/jquery/ui/themes/redmond/jquery.ui.datepicker.css');
            $this->document->addScript('catalog/view/javascript/formToWizardi.js');
            $this->document->addScript('catalog/view/javascript/jquery/jquery.maskedinput.min.js');
            $this->document->addScript('catalog/view/javascript/jquery/jquery.validate.min.js');
            $this->document->addScript('catalog/view/javascript/register.js');
            
            $this->load->model('account/customer');
		
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$dt = explode('.', $this->request->post['birthdate']);
                        $this->request->post['birthdate'] = $dt[2].'-'.$dt[1].'-'.$dt[0];
...
//                    $this->data['date_added'] = $this->request->post['birthdate'];
...
//		}
  	...
  	protected function validate() {
        ...
        if ((utf8_strlen($this->request->post['gender']) < 1) || (utf8_strlen($this->request->post['gender']) > 32)) {
      		$this->error['gender'] = $this->language->get('error_gender');
    	}
        
        if ((utf8_strlen($this->request->post['birthdate']) == "")) {
