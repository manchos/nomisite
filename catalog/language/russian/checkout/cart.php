...
$_['text_items']             = 'Товаров <span id="selred">%s</span> на сумму %s';
...
$_['error_stock']            = 'Товары, отмеченные ***, недоступны в нужном количестве или отсутствуют на складе!'
        . '<p>При отсутствии размера, выбранный товар Вы можете приобрести в сети магазинов Perfetta. Более полную информацию о наличии товара, Вы можете узнать по телефонам<a href="http://www.perfetta.ru/moscow/"> магазинов Perfetta:</a> 8 495 730-04-39</p>';
