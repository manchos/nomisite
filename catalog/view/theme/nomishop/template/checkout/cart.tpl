...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="fitting">
  <h4>Примерка</h4>
    Милые девушки, мы знаем как каждой из нас важно, что бы вещь нам нравилась, подходила и делала нас привлекательней.<br />
К заказанному Вами изделию, мы приложим так же изделие другого размера, что бы Вам было проще сделать выбор. <br />
На примерку наших изделий мы уделяем Вам <strong>15 минут!</strong> Этого вполне достаточно, что бы оценить изделие, и принять решение о приобретении. <br />
<strong>Примерка производится в непосредственной близости нашего представителя (курьера).</strong> Перед примеркой, вы произведете совместный осмотр товара на наличие повреждений, брака. 
  </div>
  <br />
  <div class="buttons">
