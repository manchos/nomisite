...
<div id="content"><?php echo $content_top; ?>
   ...
   <div class="product-info">
      ...
      <?php if ($thumb || $images) { ?>
             <div class="left">
                <?php if ($thumb) { ?>
                   <img id="zoom_03" src="<?php echo $thumb; ?>" data-zoom-image="<?php echo $iws; ?>"/>
                <?php } ?>
                ...
                <?php if (!$images) { ?>
                   <div id="gallery_01">
                      <a href="#" data-image="<?php echo $thumb ?>" data-zoom-image="<?php echo $iws; ?>">
                         <img src="<?php echo $thumb; ?>" style="display: none;" />
                      </a>
                   </div>
                <?php } ?>
                ...
                <?php if ($images) { ?>
                   <div id="gallery_01" class="image-additional">
                      <?php foreach ($images as $i => $image) { ?>
                         <a href="#"  data-image="<?php echo $image['thumbimage'] ?>" 
                            data-zoom-image="<?php echo $image['popup']; ?>" <?php if ($i == 0) echo 'class="active"'; ?> >
