<div id="quick-view-content">
  ...
  <div class="product-info quick-view-product-info">
	<div class="left">
      <?php if ($thumb) { ?>
        <div class="image"><a href="<?php echo $product_link; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="images" /></a></div>
      <?php } ?>
      <?php if ($images) { ?>
		...
		<div class="description">
		  ...
		  <div class="cart">
			<div><?php echo $text_qty; ?>
			  ...
			  &nbsp;
			  <input type="button" value="<?php echo $button_cart; ?>" id="quick-button-cart" class="button" />
			  <span>&nbsp;&nbsp;<?php echo $text_or; ?>&nbsp;&nbsp;</span>
			  <span class="links"><a onclick="addToWishListQuick('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a><br />
				<a onclick="addToCompareQuick('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></span>
			</div>
			<?php if ($minimum > 1) { ?>
	  ...
	  <div id="tab-quick-related" class="tab-contents">
		<div class="box-product">
		  ...
		  <div>
			...
			<?php } ?>
			<a onclick="addToCartQuick('<?php echo $product['product_id']; ?>');" class="button"><?php echo $button_cart; ?></a></div>
		  <?php } ?>
		</div>
	  </div>
	  <?php } ?>
